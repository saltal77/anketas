...
from survey.views import ConfirmView, IndexView, SurveyCompleted, SurveyDetail, FoundView, SearchView
...
urlpatterns = [
    ...
    url(r"^found/(?P<pin>\w+)/", FoundView.as_view(), name="survey-found"),
    url(r"^search/", SearchView.as_view(), name="survey-search")
]
